...
const ControlGanaderoStack = createStackNavigator(
  {
    ControlGanadero: {
...
const AppStack = createDrawerNavigator(
  {
    ...
    SettingStack: {
      ...
      navigationOptions: navOpt => ({
        drawerLabel: ({ focused }) => (
          <DrawerItem focused={focused} screen="Setting" title="Setting" />
        )
      })
    },
    ProStack: {
      screen: Pro,
      navigationOptions: navOpt => ({
        drawerLabel: ({ focused }) => <DrawerItem focused={focused} screen="Pro" title="Pro" />
      })
    },
    Components: {
